#!/bin/bash
# CoLA：lr=2e-4 epochs=25 maxlen=64 alpha=32 wd=0.01 | AdaLoRA tinit/tf/delta/orth=800/3500/10/0.1
...
run_task "$MASTER_PORT" cola 2e-4 25 64 32 0.01 800 3500 10 0.1
